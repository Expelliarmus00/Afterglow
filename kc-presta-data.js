...
window.KC_PRESTA = {
  ...
  mariage: {
    ...
    gallery: [
      "Préparatifs — détails de la robe", "Regard de la mariée", "Cérémonie — échange des vœux",
      "Alliances", "Sortie sous les pétales", "Couple — golden hour",
  ...
  portrait: {
    ...
    gallery: [
      "Portrait extérieur — lumière douce", "Regard franc", "En mouvement",
      "Détail / mains", "Profil — contre-jour", "Attitude lifestyle",
      "Plan rapproché", "Lumière de fin de journée", "Portrait en pied", "Noir & blanc",
    ],
    formules: [
  ...
  maternite: {
    ...
    gallery: [
      "Silhouette en contre-jour", "Détail des mains sur le ventre", "Portrait serein",
      "En couple", "Drapé / tissu fluide", "Lumière de studio",
      "Avec l'aîné(e)", "Profil — clair-obscur", "Détail intime", "Plein cadre",
    ],
    formules: [
  ...
  studio: {
    ...
    gallery: [
      "Portrait éditorial — clair", "Portrait corporate", "Clair-obscur",
      "Plan rapproché", "Attitude / posture", "Fond coloré",
      "Noir & blanc", "Détail / mains", "Portrait de profil", "Plein pied",
    ],
    formules: [
  ...
  couple: {
    ...
    gallery: [
      "Marche complice", "Regard partagé", "Étreinte — golden hour",
      "Détails des mains", "Rire spontané", "Silhouette au coucher du soleil",
      "En mouvement", "Plan rapproché", "Paysage & couple", "Tendresse",
    ],
    formules: [
  ...
  famille: {
    ...
    gallery: [
      "Famille complice en extérieur", "Fou rire d'enfant", "Câlin parent-enfant",
      "Course dans l'herbe", "Détail — petites mains", "Portrait de fratrie",
      "Tendresse à contre-jour", "Trois générations réunies", "Jeu à l'heure dorée", "Instant du quotidien",
    ],
    formules: [
