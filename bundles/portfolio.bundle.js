...
;
(()=>{const{useState}=React,PF_CATS=[{key:"all",label:"Tout"},{key:"mariage",label:"Mariages"},{key:"portrait",label:"Portraits"},{key:"studio",label:"Studio"},{key:"maternite",label:"Maternit\xE9"}],PF_ITEMS=[{id:"pf-1",cat:"mariage",ph:"Mariage \u2014 c\xE9r\xE9monie"},{id:"pf-19",cat:"portrait",ph:"Portrait \u2014 lumi\xE8re naturelle"},{id:"maternite-g0",cat:"maternite",ph:"Maternit\xE9 \u2014 silhouette"},{id:"pf-5",cat:"mariage",ph:"Mariage \u2014 pr\xE9paratifs"},{id:"pf-22",cat:"portrait",ph:"Portrait \u2014 regard",wide:!0},{id:"maternite-g1",cat:"maternite",ph:"Maternit\xE9 \u2014 douceur de l'attente",wide:!0},{id:"pf-8",cat:"mariage",ph:"Mariage \u2014 premi\xE8re danse"},{id:"pf-20",cat:"portrait",ph:"Portrait \u2014 ext\xE9rieur"},{id:"maternite-g2",cat:"maternite",ph:"Maternit\xE9 \u2014 portrait serein"},{id:"pf-24",cat:"mariage",ph:"Mariage \u2014 regards",wide:!0},{id:"maternite-g4",cat:"maternite",ph:"Maternit\xE9 \u2014 drap\xE9"},{id:"pf-12",cat:"mariage",ph:"Mariage \u2014 d\xE9tails du lieu"},{id:"pf-21",cat:"portrait",ph:"Portrait \u2014 regard franc"},{id:"maternite-g3",cat:"maternite",ph:"Maternit\xE9 \u2014 en couple"},{id:"pf-16",cat:"mariage",ph:"Mariage \u2014 sortie de c\xE9r\xE9monie"},{id:"maternite-g5",cat:"maternite",ph:"Maternit\xE9 \u2014 portrait intimiste"},{id:"pf-17",cat:"mariage",ph:"Mariage \u2014 moment cl\xE9"},{id:"maternite-g6",cat:"maternite",ph:"Maternit\xE9 \u2014 paysage",wide:!0},{id:"pf-23",cat:"mariage",ph:"Mariage \u2014 lumi\xE8re de fin de journ\xE9e"},{id:"maternite-g8",cat:"maternite",ph:"Maternit\xE9 \u2014 d\xE9tail"},{id:"studio-g0",cat:"studio",ph:"Studio \u2014 portrait \xE9ditorial"},{id:"studio-g1",cat:"studio",ph:"Studio \u2014 portrait corporate"},{id:"studio-g2",cat:"studio",ph:"Studio \u2014 clair-obscur"},{id:"studio-g3",cat:"studio",ph:"Studio \u2014 attitude"},{id:"studio-g4",cat:"studio",ph:"Studio \u2014 fond sobre"},{id:"studio-g5",cat:"studio",ph:"Studio \u2014 portrait de profil"}];function PortfolioApp(){const[t,setTweak]=useTweaks({palette:KC.PALETTES["Noir chaud"],heading:"Cinzel",body:"Jost"}),[cat,setCat]=useState("all");return useApplyTweaks(t),useReveal([cat]),React.createElement(React.Fragment,null,React.createElement("div",{className:"grain"}),React.createElement(Nav,{active:"portfolio"}),React.createElement("main",null,React.createElement("section",{className:"pf-head s-dark"},React.createElement("div",{className:"wrap"},React.createElement(Overline,{className:"reveal"},"Portfolio"),React.createElement("h1",{className:"display reveal d1"},"Travaux choisis."),React.createElement("p",{className:"reveal d2"},"Une s\xE9lection d'images \xE0 travers les mariages, les portraits et la maternit\xE9. Cliquez sur une photo pour l'agrandir."),React.createElement("div",{className:"pf-filters reveal d2"},PF_CATS.map(c=>React.createElement("button",{key:c.key,className:"pf-filter"+(cat===c.key?" active":""),onClick:()=>setCat(c.key)},c.label))))),React.createElement("section",{className:"sec s-dark",style:{paddingBottom:"clamp(90px,12vw,170px)"}},React.createElement("div",{className:"wrap"},React.createElement("div",{className:"pf-grid","data-lb-group":"portfolio"},PF_ITEMS.map(it=>React.createElement("div",{key:it.id,className:"pf-cell"+(it.wide?" pf-cell--wide":"")+(cat==="all"&&it.cat!=="studio"||it.cat===cat?"":" hide")},React.createElement(Slot,{id:it.id,ph:it.ph,style:{width:"100%",height:"100%"}})))))),React.createElement(CtaContact,{overline:"Une s\xE9ance en t\xEAte ?",title:"R\xE9servez votre date."})),React.createElement(Footer,null))}ReactDOM.createRoot(document.getElementById("root")).render(React.createElement(PortfolioApp,null));})();
